...
Remember from <!-- TO DO: Add reference --> that in ggplot2 syntax, visual objects that represent the data are called **geoms** and to define them, you use the geom functions that you add to `ggplot()`.
