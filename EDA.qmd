...
The best way to understand that pattern is to visualize the distribution of the variable's values, which you've learned about in @sec-data-visualisation. For example, to visualize the distribution of `carat`s of diamonds, a numerical variable, we can use a histogram:
