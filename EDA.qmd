...
1.  Drop the entire row with the strange values:
    ...
    We don't recommend this option because, for a given observation, just because the value for one variable is invalid doesn't mean the values for all variables are.
...
Scatterplots become less useful as the size of your dataset grows, because points begin to overplot, and pile up into areas of uniform black, making it hard to see the trend.
