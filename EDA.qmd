...
<!-- HW: now needs intro to diamonds? Maybe motivate as switching to a larger dataset -->
...
For example, to visualize the distribution of `carat`s of diamonds, a numerical variable, we can use a histogram:
...
<!-- HW: Call ahead to logicals chapter -->
