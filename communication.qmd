...
Alternatively, you might just want to share a quick insight or clarification.
To do this, you'll still need a data frame to pass to the geom.
...
#|   reads "Larger engine sizes tend to have lower fuel economy". 
...
You can also use a label geom instead of a text geom like we did earlier as well as set aesthetics like color.
