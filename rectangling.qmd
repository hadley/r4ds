...
For example, take the following dataset where the list-column `y` contains two numbers, a string, and a logical, which can't normally be mixed in a single column.
