...
#|   the four styling tools provided by the package.
...
The names will help cue the reader into what's happening and make it easier to check that intermediate results are as expected.
