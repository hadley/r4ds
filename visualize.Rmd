...
Here, the color doesn't convey information about a variable, it only changes the appearance of the plot. To set an aesthetic manually, set the aesthetic by name as an argument of your geom function. In other words, it goes _outside_ of `aes()`. You'll need to pick a value that makes sense for that aesthetic:
