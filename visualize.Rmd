...
If you run this code and get an error there is no package called ‘ggplot2’ on your machine, you'll need to first install it, and then run `library()` once again.
