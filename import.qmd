...
In this part of the book, you'll learn how to import a wider range of data into R, as well as getting it into a form useful form for further work.
...
-   In @sec-import-databases, you'll learn about getting data out of database and into R (and you'll also learn a little about how to get data out of R and into a database).
...
-   In @sec-scraping, you'll learn web "scraping", the art and science of extract data from web pages.
