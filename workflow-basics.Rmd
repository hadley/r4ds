...
1.  Press Alt + Shift + K (`r paste0(knitr::asis_output("\U2325"), "Option")` + `r paste0(knitr::asis_output("\U21E7"),"Shift")` + K on Mac). What happens? How can you get to the same place
    using the menus?
