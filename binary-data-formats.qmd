...
This operation is extremely efficient because both libraries deal with the Arrow format, so data is passed between then without making a copy. This can occasionally be valuable when one tool implements functionality that the other does not.
