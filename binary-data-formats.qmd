...
This works because parquet supports storing numeric data in binary format.
In fact, this highlights another benefit to parquet: it has a rich type system, including a number of types that (e.g. [decimal types](https://en.wikipedia.org/wiki/Decimal_data_type)) are not supported natively in R.
