...
We cement the theory with an examination of the keys in the datasets of the nycflights13 package, then use that knowledge to start joining data frames together.
