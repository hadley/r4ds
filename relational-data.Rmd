...
```{r, echo = FALSE, fig.alt = "Diagram of the relationships between airports, planes, flights, weather, and airlines datasets from the nycflights13 package. The faa variable in the airports data frame related to the origin and dest variables in the flights data frame. The tailnum variable in the planes data frame is related to the tailnum variable in flights. The year, month, day, hour, and origin variables are related to the variables with the same name in the flights data frame. And finally the carrier variables in the airlines data frame is related to the carrier variable in the flights data frame. There are no direct connections between airports, planes, airlines, and weather data frames."}
