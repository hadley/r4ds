...
2.  Instead, I recommend replacing the unusual values with missing values.
    ...
    You can use the `dplyr::if_else()` function to replace unusual values with `NA`:
...
The first argument `condition` should be a logical vector.
The result will contain the value of the second argument, `true`, when `condition` is `TRUE`, and the value of the third argument, `false`, when it is false.
