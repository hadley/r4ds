...
<!--# MCR: I usually start my webscraping lecture mentioning screen scraping vs. web APIs (see last bullet point at https://datasciencebox.org/course-materials/_slides/u2-d18-web-scrape/u2-d18-web-scrape.html#6) and saying we'll focus on the former. Is that worth mentioniong/clarifying here? -->
...
<!--# MCR: I suggest calling this section "Scraping ethics and legalities" -->
...
One easy way to do so is to use the [**polite**](https://dmi3kno.github.io/polite/) package by Dmytro Perepolkin ([https://dmi3kno.github.io/polite](https://dmi3kno.github.io/polite/)).
...
<!--# MCR: Should the hyperlinks in this section go in footnotes too for the print version? -->
...
<!--# MCR: Do you want to cache this chunk so it doesn't keep getting rerun? And do we want to recommend doing so in the text? -->
...
We've demonstrated web scraping with two case studies: a simpler scenario on scraping data on StarWars films from the rvest package website and a more complex scenario on scraping the top 250 films from IMDB.

Importantly, we started the chapter discussing the ethics and legalities of web scraping.
You learned about legal considerations like terms of service and copyright as well as the ethics of scraping and releasing personally identifiable information.
...
<!--# MCR: I attempted a summary, take a look and edit as you see fit! -->
