...
1.  Permanently, by modifying the YAML header:
    ...
    1.  Transiently, by calling `quarto::quarto_render()` by hand:
...
knitr::include_graphics("screenshots/quarto-dashboard.png")
```
...
knitr::include_graphics("screenshots/quarto-shiny.png")
```
...
-   say something about journal articles

-   say something about ipython notebooks?
