...
There are two other R packages you can use for reading and data from/to Excel: **xlsx** and **XLConnect**.
These two packages require java installed on the machine and the rJava package.
Due to potential challenges with installation, we recommend alternatives we've introduced in this chapter.
