...
Instead, we'll start with the visualization and transformation of data that's already been imported and tidied.
...
However, it is incredibly faster, and the performance payoff is worth investing some time in learning it if you're working with large data sets.
