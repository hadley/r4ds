...
If you can't get your data into R, you can't do data science on it with R!
...
Instead, we'll start with imported and tidied data, so we can go straight to making interesting insights through visualization and transformation.
