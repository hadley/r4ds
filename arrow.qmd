...
The first line in the output tells you that `seattle_csv` is stored locally on-disk as a single CSV file; it will only be loaded into memory when necessary.
...
This massive difference in performance is why whenever you're working with large CSVs, you should always convert to parquet first!
