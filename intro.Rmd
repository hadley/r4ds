...
In this book, you won't learn anything about [Python](https://www.python.org/), [Julia](http://julialang.org/), or any other programming language useful for data science. This isn't because we think these tools are bad. They're not! And in practice, most data science teams use a mix of languages, often at least R and Python.
