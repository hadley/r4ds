...
The last step of data science is __communication__, an absolutely critical part of any data analysis project. It doesn't matter how well models and visualisation have led you to understand the data, unless you can commmunicate your results to other people. Communication takes many forms, ranging from a one-off presentation to a written (possibly dynamic) report to a fully fledged product. 
