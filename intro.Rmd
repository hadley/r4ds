...
Data science is an exciting discipline that allows you to turn raw data into understanding, insight, and knowledge. But because data science is a huge field, there’s no way you can master it by reading a single book. That's why the goal of “R for Data Science” is to introduce you to the best parts of R, the parts that will give you a solid foundation in the tools that'll help you tackle the six tasks of a typical data science project.

## What you will learn

The six tasks are importing, tidying, transforming, visualising, modeling and communication.
