...
This chapter will focus on the __stringr__ package for string manipulation. stringr is now part of the core tidyverse, but since for previous versions of the tidyverse (before 1.2.0) it wasn't included, you may need to load it explicitly.
