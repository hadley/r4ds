...
In most cases, you'll get numbers already recorded in one R's numeric types, integer or double.
In some cases, however, you'll encounter them as strings, possibly because you've created the by pivotting from column headers or something has gone wrong in your data import process.
...
This is particularly useful for currency data:
...
You've also learned a handful of useful general transformations that are commonly, but not exclusively, applied to numeric vector like ranks and offsets.
