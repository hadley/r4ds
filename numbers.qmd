...
(Despite the advice in [Chapter -@sec-code-style], I usually put `count()` on a single line because I'm usually using it at the console for a quick check that my calculation is working as expected.)
