...
This chapter focuses on the tools you need to create good graphics. I assume you have an idea of what you want, and just need to know how to do it. For that reason, I highly recommend pairing this advice with a good general visualisation book. I particularly like [_The Truthful Art_](https://amzn.com/0321934075), by Albert Cairo. I doesn't teach the mechanics of creating visualisations, but instead focuses on what you need to think about in order to create effective graphics.
