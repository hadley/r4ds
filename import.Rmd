...
* They refrain from doing annoying things like converting character vectors to 
  factors. And don't mangle the column names when headers aren't valid R variable names.
...
readr also provides a number of functions for reading files from disk into data structures simpler than a data frame:
