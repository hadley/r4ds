...
In this chapter, you'll expand on that foundation as you learn about the layered grammar of graphics, starting with data, then aesthetics and geometries, and then facets, statistics, coordinates, and themes.
We will not cover every single function and option for each of these layers, but we will walk you through the most important and commonly used functionality provided by ggplot2.
...
In this chapter, we will mostly use the `mpg` data frame that is bundled with the ggplot2 package.
