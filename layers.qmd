...
shapes <- tibble(
  shape = c(0, 1, 2, 3, 4, 5, 6:19, 20, 21, 22, 23, 24),
  x = (0:24 %/% 5) / 2,
  y = (-(0:24 %% 5)) / 4
)
...
Every geom function in ggplot2 takes a `mapping` argument, which it inherits from `ggplot()`.
...
3.  Most geoms and stats come in pairs that are almost always used in concert.
    Make a list of all the pair.
    What do they have in common?
    (Hint: Read through the documentation to find the pairs.)
