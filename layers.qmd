...
The first argument of `facet_wrap()` is a formula[^layers-1], which you create with `~` followed by a variable name.
The variable that you pass to `facet_wrap()` should be discrete.

[^layers-1]: Here "formula" is the name of the type of thing created by `~`, not a synonym for "equation".
