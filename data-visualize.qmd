...
#TODO strange sentence, is this English? Perhaps no "by" and a question mark? Also, needs an s to penguin but no s to "lives", I suppose.
...
#TODO does not appear in my Environment pane, presumably because it is not in my context but in the package’s context.
