...
<!-- HW: Needs brief outline of what the chapter will cover -->
...
<!-- HW: need some comment about this code and how you don't need to worry about understanding it yet -->
...
### A graphing template {#sec-graphing-template}

<!-- HW: I think it would be fine to drop this subsection -->
...
<!-- HW: should this be a subection of "first steps" -->
...
5.  Run this code in your head and predict what the output will look like.
...
6.  Will these two graphs look different?
    Why/why not?
...
<!-- HW: feel free to remove this if you don't like it -->
...
<!-- HW: call ahead to projects chapter to talk about where the plot will be saved? -->
