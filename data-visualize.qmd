...
The first argument of `facet_wrap()` is a variable name quoted by `vars()`[^data-visualize-3].
The variable that you pass to `facet_wrap()` should be categorical.

[^data-visualize-3]: Unless you quote by `vars()`, you will see an error: object not found.
