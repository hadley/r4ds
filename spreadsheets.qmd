...
#| fig-alt: |
#|   A look at the penguins spreadsheet in Excel. The spreadsheet contains 
...
#|   on top that contain non-data information; the text 'For the sake of 
...
Similarly, dates are actually stored as numbers, specifically the number of days since January 1, 1900.
