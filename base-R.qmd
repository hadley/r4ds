...
To finish off, we'll also very briefly mention two important plotting functions.
...
Note that base plotting functions work with vectors, so you need to pull columns out of the data frame with `$`.
...
We hope you've enjoyed learning more about programming and are looking forward to learning more outside of this book.
