...
When working with factors, the two most common operations are changing the order of the levels, and changing the values of the levels. These operations are described in the sections below.
