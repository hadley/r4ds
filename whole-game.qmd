...
The goal of the first part of this book is to introduce you the basic data exploration workflow of **importing**, **tidying**, **transforming**, and **visualizing**, as shown in @fig-ds-whole-game. Data exploration is the art of looking at your data, rapidly generating hypotheses, quickly testing them, then repeating again and again and again.
...
Our goal is to give useful tools with immediate payoff:
