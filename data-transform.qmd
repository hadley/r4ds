...
6.  Suppose we have the following tiny data frame:
    ...
    a.  What does the following code do? Run it and analyze the result and describe what `group_by()` does.
    ...
    b.  What does the following code do? Run it and analyze the result and describe what `arrange()` does. Also comment on how it's different from the `group_by()` in part (a)?
    ...
    c.  What does the following code do? Run it and analyze the result and describe what the pipeline does.
    ...
    d.  What does the following code do? Run it and analyze the result and describe what the pipeline does. Then, comment on what the message says.
    ...
    e.  What does the following code do? Run it and analyze the result and describe what the pipeline does. How is the output different from the one in part (d).
    ...
    f.  What do the following pipelines do? Run both and analyze their results and describe what each pipeline does. How are the outputs of the two pipelines different?
