...
Instead of grouping and ungrouping you data, you can use the `.by` argument to group a single operation:
...
We didn't focus on this syntax in this book because it's still very very new, but we think it has a lot of promise and we think it's likely to be quite popular.
