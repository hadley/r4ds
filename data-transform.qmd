...
#TODO please consider stating somewhere briefly what the letters "dplyr" stand for.
...
#TODO A bit of repetition here, this was explained before.
...
#TODO I’d remove the following sentence, because the previous sentences are clear enough, it doesn’t add anything (and arguably one may find it “terribly useful” to be able to easily focus on a reduced set of variables even when having “only” 19 of them to start with).
