...
This is called a `tbl_df` (prounced "tibble diff") or a `data_frame` (pronunced "data underscore frame"; cf. `data dot frame`). Generally, however, we won't worry about this relatively minor difference and will refer to everything as data frames.
...
*  #When you extract a variable with `$`, tbl\_dfs never do partial 
   ...
   # df2$a
   # ```
   # This is not true, tbl_df partial matches perfectly
--------------------------------------------------------------------------------
...
```{r bool-ops, echo = FALSE, out.width = "75%"}
