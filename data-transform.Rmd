...
# TO DO: Is this being used anywhere?
...
The number in the square brackets (`r nrow(distinct(daily, year, month, day))`) indicates how many groups are created.

When you group by multiple variables, each summary peels off one level of the grouping by default, and a message is printed that tells you how you can override this behaviour.

```{r}
summarise(daily, flights = n())
```

You can suppress the message by explicitly defining this default behaviour.
