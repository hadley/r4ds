...
This text is formatted in a special way, called Markdown, which can be pasted to sites like Stack Overflow or GitHub and they will automatically render it to look like code.
